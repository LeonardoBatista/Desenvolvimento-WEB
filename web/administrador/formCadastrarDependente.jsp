<%-- 
    Document   : formCadastrarDependente
    Created on : 27/04/2018, 08:47:18
    Author     : Wellington
--%>
                ...
                <div class="container">
                    ...
                    <div class="card-body">
                            ...
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <label for="nomeDependente">Nome <span class="required">*</span></label>
                                        <input class="form-control" id="nomeDependente" nome="nomeDependente" maxlength="50" type="text" aria-describedby="nameHelp">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <label for="dtDependente">Data do dependente</label>
                                        <input class="form-control" id="dtDependente" nome="dtDependente" type="text" aria-describedby="nameHelp">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="cmbSexo">Sexo <span class="required">*</span></label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select id="cmbUFLocalidade" name="cmbSexo" class="form-control col-md-3 col-xs-8">	 
                        ...
                        <%
                            ...
                            out.println("<th class='col-xs-1'>Data nascimento</th>");
                            out.println("<th class='col-xs-1'>Sexo</th>");
                            out.println("<th class='col-xs-1'>Ativo/Desativo</th>");
                            out.println("<th class='col-xs-1'>Socio</th>");
                            out.println("<th class='col-xs-1'>Ações</th>");
                            out.println("</tr>");

                            for (int ii = 0; ii < Dependentes.size(); ii++) {
                                out.println("<form  method='POST'  action='../CtrlCadastrarCliente'"); 
                                out.println("<tr>");
                                out.println("<td>" + Dependentes.get(ii).getNome() + "</td>");
                                out.println("<td>" + Dependentes.get(ii).getDtNascimento() + "</td>");
                                out.println("<td>" + Dependentes.get(ii).getSexo() + "</td>");
                                out.println("<td>" + Dependentes.get(ii).isEstaAtivo() + "</td>");
                                out.println("<td>" + Dependentes.get(ii).getSocio().getNome() + "</td>");
                                out.println("<td>");
