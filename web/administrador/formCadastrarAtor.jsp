<%-- 
    Document   : formCadastrarAtor
    Created on : 10/04/2018, 10:49:34
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="container">
                    ...
                    <div class="card-header">Gerenciar Ator</div>
                    <div class="card-body"> 
                        <form name="teste"  method="POST"  action="../CtrlCadastrarAtor">
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <label for="nomeAtor">Nome <span class="required">*</span></label>
                                        <input class="form-control" id="nomeAtor" name="nomeAtor" maxlength="50" type="text" aria-describedby="nameHelp">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <%
                            ...
                            for (int i = 0; i < Atores.size(); i++) {
                                ...
                                out.println("<input type='hidden' name='id' value='" + Atores.get(i).getId() + "'>");
                                out.println("</li>");
                                out.println("</ul>");
                                out.println("</div>");
                                out.println("</td>");
