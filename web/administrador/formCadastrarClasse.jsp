<%-- 
    Document   : formCadastrarClasse
    Created on : 17/04/2018, 20:09:56
    Author     : Wellington
--%>
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="container">
                    ...
                    <div class="card-header">Gerenciar Classe</div>
                    <div class="card-body">
                        <form name="teste"  method="POST"  action="../CtrlCadastrarClasse">
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <label for="nomeClasse">Nome <span class="required">*</span></label>
                                        <input class="form-control" id="nomeClasse" name="nomeClasse" maxlength="50" type="text" aria-describedby="nameHelp">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <label for="valorClasse">Valor <span class="required">*</span></label>
                                        <input class="form-control" id="valorClasse" name="valorClasse" maxlength="5" type="text" aria-describedby="nameHelp">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        ...
                                        <input class="form-control" id="dtDevolucao" name="devolucao" type="text" aria-describedby="nameHelp">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <%
                            ...
                            out.println("<th class='col-xs-1'>Valor</th>");
                            out.println("<th class='col-xs-1'>Data de devolução</th>");
                            out.println("<th class='col-xs-1'>Ações</th>");
                            out.println("</tr>");

                            for (int i = 0; i < Classes.size(); i++) {
                                out.println("<form  method='POST'  action='../CtrlCadastrarClasse'");
                                out.println("<tr>");
                                out.println("<td>" + Classes.get(i).getNome() + "</td>");
                                out.println("<td>" + Classes.get(i).getValor() + "</td>");
                                out.println("<td>" + Classes.get(i).getPrazoDevolucao() + "</td>");
                                out.println("<td>");
                                ...
                                out.println("<input type='hidden' name='id' value='" + Classes.get(i).getId() + "'>");
                                out.println("</li>");
                                out.println("</ul>");
                                out.println("</div>");
                                out.println("</td>");
