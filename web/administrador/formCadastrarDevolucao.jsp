<%-- 
    Document   : formCadastrarDevolucao
    Created on : 27/04/2018, 08:35:25
    Author     : Wellington
--%>
    ...
    <body class="bg-dark">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="container">
                    <div class="card-header">Gerenciar Devolução</div>
                    <div class="card-body">
                        <form name="teste"  method="POST"  action="../CtrlCadastrarDevolucao">
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-4 col-sm-4 col-xs-12">
                                        <label for="numeroSerieItemDevolucao">N° Série <span class="required">*</span></label>
                                        <input class="form-control" id="numeroSerieItemDevolucao" name="numeroSerieItemDevolucao" maxlength="18" type="text" aria-describedby="nameHelp">
                                    </div>
                                </div>
                            </div>
                        <!--<div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <label for="estadoLocacao">Estado de locacao <span class="required">*</span></label>
                                        <input class="form-control" id="estadoLocacao" name="estadoLocacao" maxlength="50" type="text" aria-describedby="nameHelp">
                                    </div>
                                </div>
                            </div>-->
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-3 col-sm-3 col-xs-12">
                                        <label for="valorAPagar">Valor a pagar <span class="required">*</span></label>
                                        <input class="form-control" id="valorAPagar" name="valorAPagar" maxlength="6" type="text" aria-describedby="nameHelp">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <%
                            ...
                            for (int i = 0; i < Locacoes.size(); i++) {
                                ...
                                out.println("<tr>");
                                out.println("<td>" + Locacoes.get(i).getItem().getNumSerie() + "</td>");
