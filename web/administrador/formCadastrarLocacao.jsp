<%-- 
    Document   : formCadastrarLocacao
    Created on : 30/04/2018, 14:46:31
    Author     : Wellington
--%>
    ...
    <body class="bg-dark">
        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                ...
                <div class="card-header">Gerenciar Locação</div>
                <div class="card-body">
                    <form name="teste"  method="POST"  action="../CtrlCadastrarLocacao">
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <label for="dtAtualLocacao">Data de Locação</label>
                                    <input class="form-control" id="dtAtualLocacao" nome="dtAtualLocacao" type="text" aria-describedby="nameHelp">
                                </div>
                            </div>
                        </div> 
                        <div class="form-group">
                            <div class="form-row">
                                <div class="col-md-3 col-sm-3 col-xs-12">
                                    <label for="dtAtualLocacao">Data de Prevista</label>
                                    <input class="form-control" id="dtDevolucaoPrevistaLocacao" nome="dtDevolucaoPrevistaLocacao" type="text" aria-describedby="nameHelp">
                                </div>
                            </div>
                        </div> 
                        <div class="form-group">
                    ...
                    <div class="col-md-10 col-sm-1 col-xs-2">
                      <form action='/search' id='search-form' method='get' target='_top'>
                        ...
                        <%
                            ...
                            out.println("<th class='col-xs-1'>Data Prevista</th>");
                            out.println("<th class='col-xs-1'>Valor cobrado</th>");
                            out.println("<th class='col-xs-1'>Item</th>");
                            out.println("<th class='col-xs-1'>Cliente</th>");
                            out.println("<th class='col-xs-1'>Ações</th>");
                            out.println("</tr>");

                            for (int i = 0; i < Locacoes.size(); i++) {
                                out.println("<form  method='POST'  action='../CtrlCadastrarLocacao'"); 
                                out.println("<tr>");
                                out.println("<td>" + Locacoes.get(i).getDtLocacao() + "</td>");
                                out.println("<td>" + Locacoes.get(i).getDtDevolucaoPrevista() + "</td>");
                                out.println("<td>" + Locacoes.get(i).getValorCobrado() + "</td>");
                                out.println("<td>" + Locacoes.get(i).getItem().getTipoItem() + "</td>");
                                out.println("<td>" + Locacoes.get(i).getCliente().getNome() + "</td>");
                                out.println("<td>");
