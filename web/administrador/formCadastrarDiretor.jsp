        ...
        <div class="content-wrapper">
            <div class="container-fluid">
                <div class="container">
                    ...
                    <div class="card-header">Gerenciar Diretor</div>
                    <div class="card-body">
                        <form name="teste"  method="POST"  action="../CtrlCadastrarDiretor">
                            <div class="form-group">
                                <div class="form-row">
                                    <div class="col-md-8 col-sm-8 col-xs-12">
                                        <label for="nomeDiretor">Nome <span class="required">*</span></label>
                                        <input class="form-control" id="nomeAtor" name="nomeDiretor" maxlength="50" type="text" aria-describedby="nameHelp">
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <%
                            ...
                            for (int i = 0; i < Diretores.size(); i++) {
                                out.println("<form  method='POST'  action='../CtrlCadastrarDiretor'");
                                out.println("<tr>");
                                ...
                                out.println("<input type='hidden' name='id' value='" + Diretores.get(i).getId() + "'>");
                                out.println("</li>");
                                out.println("</ul>");
                                out.println("</div>");
                                out.println("</td>");
